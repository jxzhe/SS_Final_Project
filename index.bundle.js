    ...
    _createClass(Menu, [{
        ...
        value: function create_main_layer() {
            ...
            this.talk_sign_pumpgirl.btns.player1.events.onInputOver.add(function () {
                _this3.add.tween(_this3.talk_sign_pumpgirl.btns.player1).to({ fontSize: 25 }, 100).start();
            });
            this.talk_sign_pumpgirl.btns.player2.events.onInputOver.add(function () {
                _this3.add.tween(_this3.talk_sign_pumpgirl.btns.player2).to({ fontSize: 25 }, 100).start();
            });
